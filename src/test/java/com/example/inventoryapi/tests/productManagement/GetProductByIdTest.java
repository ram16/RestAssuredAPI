...
public class GetProductByIdTest extends TestBase {
    ...
    public void testGetProductById() throws Exception {
        ...
        // Validate the response for getting the product
    ...
    public void testGetProductById400_BadRequest() {
    ...
    @Test(groups = {"regression"})
    public void testGetProductById401_Unauthorized() throws Exception {
        // Create a product first
        ObjectMapper objectMapper = new ObjectMapper();
        ProductRequest productRequest = new ProductRequest("UnauthorizedGetById", 10.0, "games", 1);
        String createJson = objectMapper.writeValueAsString(productRequest);
        Response createResponse = RestAssured.given()
                .contentType(ContentType.JSON)
                .header("Authorization", "Bearer " + token)
    ...
    @Test(groups = {"regression"})
    public void testGetProductById500_InternalServerError() {
